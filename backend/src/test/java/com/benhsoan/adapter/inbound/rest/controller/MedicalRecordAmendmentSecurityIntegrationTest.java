...
@Import({
        ...
        MedicalRecordAmendmentSecurityIntegrationTest.AspectTestConfig.class,
...
class MedicalRecordAmendmentSecurityIntegrationTest {
    ...
    private final UUID amendmentId = UUID.randomUUID();
    private final UUID doctorId = UUID.randomUUID();

    @Test
    void doctorWithMedicalRecordUpdatePermissionReturnsCreated() throws Exception {
        when(amendMedicalRecordUseCase.amend(any(), any())).thenReturn(new MedicalRecordAmendmentResult(
                amendmentId, recordId, "Correction", "Clarification", doctorId, Instant.parse("2026-08-21T00:00:00Z")));
