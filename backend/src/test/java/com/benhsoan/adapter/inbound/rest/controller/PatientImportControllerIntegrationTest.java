...
class PatientImportControllerIntegrationTest {
        ...
        @MockitoBean
        private UpdatePatientPregnancyStatusUseCase updatePatientPregnancyStatusUseCase;
        @MockitoBean
        private GetPatientByIdUseCase getPatientByIdUseCase;
        @MockitoBean
        private GetPatientByCodeUseCase getPatientByCodeUseCase;
        @MockitoBean
        private MergePatientsUseCase mergePatientsUseCase;
        @MockitoBean
        private FindDuplicatePatientsUseCase findDuplicatePatientsUseCase;
        @MockitoBean
        private DownloadPatientImportTemplateUseCase downloadPatientImportTemplateUseCase;
        @MockitoBean
        private PreviewPatientImportUseCase previewPatientImportUseCase;
        @MockitoBean
        private ImportPatientsUseCase importPatientsUseCase;
        @MockitoBean
        private GetPatientImportLogsUseCase getPatientImportLogsUseCase;
        ...
        private static final SimpleGrantedAuthority PERMISSION_IMPORT = new SimpleGrantedAuthority(
                        "PERMISSION_PATIENT_IMPORT");
        private static final SimpleGrantedAuthority PERMISSION_PATIENT_READ = new SimpleGrantedAuthority(
        ...
        void allowsAuthorizedUserToDownloadTemplate() throws Exception {
                ...
                mockMvc.perform(get("/patients/import/template")
                                ...
                                .andExpect(header().string(HttpHeaders.CONTENT_DISPOSITION,
                                                "attachment; filename=\"mau_danh_sach_benh_nhan.xlsx\""));
        }
        ...
        void allowsImportWithValidXlsx() throws Exception {
                ...
                when(importPatientsUseCase.importPatients(any())).thenReturn(
                                new PatientImportResult(logId, "danh_sach.xlsx", 5, 5, 0, 0, List.of("BN-001"),
                                                List.of()));
