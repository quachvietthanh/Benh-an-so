...
class PortalLookupSecurityIntegrationTest {
    ...
    @Test
    void allowsPublicLookupWithoutJwt() throws Exception {
    ...
    @Test
    void returnsNotFoundForInvalidCodeWithoutJwt() throws Exception {
        when(lookupPortalResultUseCase.lookup(new LookupPortalResultQuery(CODE, null)))
