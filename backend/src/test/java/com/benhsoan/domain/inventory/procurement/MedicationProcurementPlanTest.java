...
class MedicationProcurementPlanTest {
    ...
    private MedicationProcurementItem createSampleItem(UUID medId, int currentStock, int minStock, int consumption, int suggested, int proposed) {
    ...
    void emptyItemsThrowsException() {
        assertThrows(ProcurementPlanEmptyItemsException.class, () ->
