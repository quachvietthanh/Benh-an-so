...
class SendSigningReminderServiceTest {
    ...
    @Mock private SigningReminderNotificationPort notificationPort;
    @Mock private AuditLogRepository auditLogRepository;
    @Mock private CurrentUserPort currentUserPort;
    @Mock private ClockPort clockPort;
    @Spy private ObjectMapper objectMapper = new ObjectMapper();

    @InjectMocks private SendSigningReminderService service;
    ...
    private MedicalRecord createDraftRecord() {
        return MedicalRecord.restore(
                ...
                MedicalRecordStatus.DRAFT, null, null, null, null, null, actorId, completedAt, null, null
        );
    }
    ...
    private Visit createCompletedVisit() {
        return Visit.restore(
                ...
                completedAt.minus(Duration.ofHours(1)), completedAt.minus(Duration.ofMinutes(50)), completedAt,
    ...
    void sendReminderSuccess() {
        ...
        when(reminderRepository.save(any(MedicalRecordSigningReminder.class))).thenAnswer(inv -> inv.getArgument(0));

        SigningReminderResult result = service.sendReminder(new SendSigningReminderCommand(recordId, "SYSTEM", "Nhắc ký bệnh án"));
    ...
    void recordAlreadySignedThrows() {
        MedicalRecord record = MedicalRecord.restore(
                recordId, visitId, "Headache", "Fever", null, null, null, null, null, null,
                MedicalRecordStatus.SIGNED, "signature", completedAt, doctorId, null, null, actorId, completedAt, null, null
        );
