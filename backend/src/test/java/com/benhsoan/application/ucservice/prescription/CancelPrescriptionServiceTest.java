...
class CancelPrescriptionServiceTest {
    ...
    private final PrescriptionClinicalContextValidator clinicalContextValidator = mock(PrescriptionClinicalContextValidator.class);
    private final CurrentUserPort currentUserPort = mock(CurrentUserPort.class);
    private final ClockPort clockPort = mock(ClockPort.class);
    private final AuditLogRepository auditLogRepository = mock(AuditLogRepository.class);
    private final PrescriptionAccessDeniedAuditWriter accessDeniedAuditWriter = mock(PrescriptionAccessDeniedAuditWriter.class);
    ...
    void cancel_success() {
        ...
        CancelPrescriptionCommand command = new CancelPrescriptionCommand(prescriptionId, "Bệnh nhân đổi phác đồ điều trị");
        ...
        verify(clinicalContextValidator).requireDoctorPermissionForPrescriptionCancellation(medicalRecordId, DOCTOR_ID);
    ...
    void cancel_doctorNotResponsibleForVisit() {
        ...
        when(currentUserPort.getCurrentUserId()).thenReturn(DOCTOR_ID);
        when(prescriptionRepository.findByIdForUpdate(prescriptionId)).thenReturn(Optional.of(prescription));
        when(clinicalContextValidator.requireDoctorPermissionForPrescriptionCancellation(medicalRecordId, DOCTOR_ID))
                .thenThrow(new AccessDeniedException("Only the doctor responsible for the visit can cancel prescriptions."));
