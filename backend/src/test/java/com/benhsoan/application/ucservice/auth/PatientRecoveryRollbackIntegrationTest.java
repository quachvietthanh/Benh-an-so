...
class PatientRecoveryRollbackIntegrationTest {
    ...
    void shouldPersistIncrementedAttemptsEvenWhenServiceThrowsInvalidVerificationCodeException() {
        ...
        assertEquals(1, updatedToken.getAttempts(), "Attempts must be 1 in DB despite exception and business rollback");
    }
    ...
    void shouldPersistAttemptsOnVerifyCodeFailure() {
        ...
        assertThrows(InvalidVerificationCodeException.class, () -> verifyRecoveryCodeUseCase.verifyCode(command));
