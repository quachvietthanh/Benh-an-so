...
class PatientFamilyHistoryServiceTest {
        ...
        private final PatientFamilyHistoryRepository familyHistoryRepository = mock(
                        PatientFamilyHistoryRepository.class);
        ...
        void retrievesFamilyHistoryForPatient() {
                ...
                when(familyHistoryRepository.findByPatientIdAndActiveTrue(PATIENT_ID))
                                .thenReturn(List.of(familyHistory));
