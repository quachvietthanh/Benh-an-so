...
class CreateDiscountRequestServiceTest {
        ...
        void createsPercentageDiscountRequestSuccessfully() {
                ...
                when(discountRequestRepository.existsByVisitIdAndStatus(visitId, DiscountRequestStatus.PENDING))
                                .thenReturn(false);
        ...
        void rejectsWhenApprovedDiscountAlreadyExists() {
                ...
                when(discountRequestRepository.existsByVisitIdAndStatus(visitId, DiscountRequestStatus.PENDING))
                                .thenReturn(false);
                when(discountRequestRepository.existsByVisitIdAndStatus(visitId, DiscountRequestStatus.APPROVED))
                                .thenReturn(true);
