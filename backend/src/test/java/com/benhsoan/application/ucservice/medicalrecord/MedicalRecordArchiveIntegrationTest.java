...
class MedicalRecordArchiveIntegrationTest {
    ...
    private GetEligibleForArchiveMedicalRecordsService eligibleService;
    ...
    void setUp() {
        ...
        eligibleService = new GetEligibleForArchiveMedicalRecordsService(
                archiveQueryRepository, clinicConfigurationRepository, authorizationService, clockPort
        );
        ...
        MedicalRecordRetentionPolicy retentionPolicy = new MedicalRecordRetentionPolicy(clinicConfigurationRepository);
    ...
    void tc02_denyEditOrDeleteOnArchivedRecord() {
        ...
        MedicalRecord archivedRecord = MedicalRecord.restore(
                ...
                NOW.minusSeconds(10000), DOCTOR_ID, null, null, DOCTOR_ID,
                NOW.minusSeconds(10000), null, null, null, null, null, NOW.minusSeconds(5000), ADMIN_ID
        );

        when(medicalRecordRepository.findById(RECORD_ID)).thenReturn(Optional.of(archivedRecord));

        // 1. Thử xóa hồ sơ lưu trữ: phải ném MedicalRecordArchivedReadOnlyException và ghi nhật ký từ chối
        ...
        // 2. Thử sửa hồ sơ lưu trữ: ensureEditable() phải ném MedicalRecordArchivedReadOnlyException
    ...
    void tc03_searchArchivedRecordsReturnsFullContent() {
        ...
        SearchArchivedMedicalRecordsQuery query = new SearchArchivedMedicalRecordsQuery("BN-0001", null, null, null);
    ...
    void batchArchive_archivesEligibleRecords() {
        ...
        BatchArchiveMedicalRecordResult batchResult = batchArchiveService.batchArchive(List.of(RECORD_ID), false);
