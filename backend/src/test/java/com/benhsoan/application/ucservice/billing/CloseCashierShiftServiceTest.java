...
class CloseCashierShiftServiceTest {
        ...
        @Mock
        private CashierShiftCodeGenerator shiftCodeGenerator;
        @Mock
        ...
        @Mock
        private CashierShiftAuthorizationAuditService authorizationAuditService;
        ...
        void shouldIncludeRefundedPaymentsInShiftSettlement() {
                ...
                Payment refunded = Payment.restore(
                                ...
                                PaymentMethod.CASH, PaymentStatus.REFUNDED, cashierId, p2Time, "Hoàn trả test",
                                UUID.randomUUID(), p2Time, p2Time, (UUID) null);
        ...
        void shouldCalculateSignedAmountWhenRefundsExceedPayments() {
                ...
                Payment refunded = Payment.restore(
                                ...
                                PaymentMethod.CASH, PaymentStatus.REFUNDED, cashierId, p2Time, "Hoàn trả toàn bộ",
                                UUID.randomUUID(), p2Time, p2Time, (UUID) null);
        ...
        private Payment createPayment(BigDecimal amount, PaymentMethod method, Instant paidAt) {
                return Payment.restore(
                                ...
                                amount, amount,
                                method, PaymentStatus.RECORDED, cashierId, paidAt, null, null, null, paidAt,
                                (UUID) null);
        }
}
