...
public class ClinicalResultHistory {
    ...
    private BigDecimal oldLowerBound, newLowerBound, oldUpperBound, newUpperBound;
    ...
    private ClinicalResultHistory(UUID id, UUID resultId, ClinicalResultType ot, ClinicalResultType nt, BigDecimal on, BigDecimal nn, BigDecimal obl, BigDecimal nbl, BigDecimal obu, BigDecimal nbu, String ox, String nx, String ou, String nu, String or, String nr, ClinicalResultAbnormalFlag of, ClinicalResultAbnormalFlag nf, String oc, String nc, ClinicalResultStatus os, ClinicalResultStatus ns, String reason, UUID by, Instant at) {
    ...
    public static ClinicalResultHistory restore(UUID id, UUID resultId, ClinicalResultType oldResultType, ClinicalResultType newResultType, BigDecimal oldNumericValue, BigDecimal newNumericValue, String oldTextValue, String newTextValue, String oldUnit, String newUnit, String oldReferenceRange, String newReferenceRange, ClinicalResultAbnormalFlag oldAbnormalFlag, ClinicalResultAbnormalFlag newAbnormalFlag, String oldConclusion, String newConclusion, ClinicalResultStatus oldStatus, ClinicalResultStatus newStatus, String changeReason, UUID changedBy, Instant changedAt) {
        return restore(id, resultId, oldResultType, newResultType, oldNumericValue, newNumericValue, null, null, null, null, oldTextValue, newTextValue, oldUnit, newUnit, oldReferenceRange, newReferenceRange, oldAbnormalFlag, newAbnormalFlag, oldConclusion, newConclusion, oldStatus, newStatus, changeReason, changedBy, changedAt);
    }

    public static ClinicalResultHistory restore(UUID id, UUID resultId, ClinicalResultType oldResultType, ClinicalResultType newResultType, BigDecimal oldNumericValue, BigDecimal newNumericValue, BigDecimal oldLowerBound, BigDecimal newLowerBound, BigDecimal oldUpperBound, BigDecimal newUpperBound, String oldTextValue, String newTextValue, String oldUnit, String newUnit, String oldReferenceRange, String newReferenceRange, ClinicalResultAbnormalFlag oldAbnormalFlag, ClinicalResultAbnormalFlag newAbnormalFlag, String oldConclusion, String newConclusion, ClinicalResultStatus oldStatus, ClinicalResultStatus newStatus, String changeReason, UUID changedBy, Instant changedAt) {
        return new ClinicalResultHistory(id, resultId, oldResultType, newResultType, oldNumericValue, newNumericValue, oldLowerBound, newLowerBound, oldUpperBound, newUpperBound, oldTextValue, newTextValue, oldUnit, newUnit, oldReferenceRange, newReferenceRange, oldAbnormalFlag, newAbnormalFlag, oldConclusion, newConclusion, oldStatus, newStatus, changeReason, changedBy, changedAt);
    }
}
