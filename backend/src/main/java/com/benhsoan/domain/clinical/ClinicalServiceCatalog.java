...
public class ClinicalServiceCatalog {
    ...
    private ClinicalServiceCatalog(UUID id, String code, String name, ClinicalServiceType type, ClinicalResultDataType dataType, String unit, String range, String description, boolean active, Instant created, Instant updated) {
    ...
    public static ClinicalServiceCatalog restore(UUID id, String code, String name, ClinicalServiceType type, ClinicalResultDataType dataType, String unit, String range, String description, boolean active, Instant created, Instant updated) {
        return new ClinicalServiceCatalog(id, code, name, type, dataType, unit, range, description, active, created, updated);
    }
