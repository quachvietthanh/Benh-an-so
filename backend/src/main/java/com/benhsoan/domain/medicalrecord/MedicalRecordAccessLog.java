...
public class MedicalRecordAccessLog {
    ...
    private MedicalRecordAccessLog(UUID id, UUID patientId, UUID visitId, UUID recordId, UUID by, MedicalRecordAccessAction action, String detail, String ip, Instant at) {
    ...
    public static MedicalRecordAccessLog restore(UUID id, UUID patientId, UUID visitId, UUID recordId, UUID by, MedicalRecordAccessAction action, String detail, String ip, Instant at) {
        return new MedicalRecordAccessLog(id, patientId, visitId, recordId, by, action, detail, ip, at);
    }
}
