    ...
    public BackupRestorePlan fullBackupRestorePlan() {
        return new BackupRestorePlan(
                List.of(
                        ...
                        "doctor_room_assignments", "doctor_specialties", "room_specialties", "medical_queues", "queue_items", "visits",
                        "follow_up_reminders", "post_care_logs",
                ...
                List.of(
                        ...
                        dependency("doctor_specialties", "specialty_id", "specialties"),
                        dependency("room_specialties", "room_id", "rooms"),
                        dependency("room_specialties", "specialty_id", "specialties"),
                        ...
                        dependency("post_care_logs", "patient_id", "patients"),
