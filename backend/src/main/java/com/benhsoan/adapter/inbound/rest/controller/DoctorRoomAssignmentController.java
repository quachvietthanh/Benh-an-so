...
public class DoctorRoomAssignmentController {
    ...
    private final SearchDoctorRoomAssignmentsUseCase searchUseCase;
    private final AssignDoctorRoomUseCase assignUseCase;
    private final RemoveDoctorRoomAssignmentUseCase removeUseCase;
    private final DoctorRoomAssignmentRestMapper mapper;

    @GetMapping("/doctor-room-assignments")
    @RequirePermission("ROOM_ASSIGNMENT_READ")
    ...
    @PutMapping("/doctors/{doctorId}/room-assignment")
    @RequirePermission("ROOM_ASSIGNMENT_UPDATE")
    ...
    @DeleteMapping("/doctors/{doctorId}/room-assignment")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @RequirePermission("ROOM_ASSIGNMENT_UPDATE")
    public void remove(@PathVariable UUID doctorId) {
        removeUseCase.remove(doctorId);
    }
}
