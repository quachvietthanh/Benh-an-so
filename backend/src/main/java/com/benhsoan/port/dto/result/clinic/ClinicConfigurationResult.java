...
public record ClinicConfigurationResult(
    ...
    public ClinicConfigurationResult(
        ...
        this(clinicName, address, phone, openingTime, closingTime, retentionYears, 24, 30, 5);
    }
    ...
    public ClinicConfigurationResult(
        ...
        this(clinicName, address, phone, openingTime, closingTime, retentionYears, signingDeadlineHours, 30, 5);
    }
