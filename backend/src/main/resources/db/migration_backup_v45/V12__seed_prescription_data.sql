...
(UUID_TO_BIN('16300000-0000-0000-0000-000000000001'), UUID_TO_BIN('16200000-0000-0000-0000-000000000001'), UUID_TO_BIN('16000000-0000-0000-0000-000000000001'), 'Paracetamol 500 mg', 'Paracetamol', '500 mg', 'vien', '1 vien', 3, 'ORAL', 3, 9, 'Uong sau an, toi da 3 g moi ngay.', '2026-08-20 02:30:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000002'), UUID_TO_BIN('16200000-0000-0000-0000-000000000001'), UUID_TO_BIN('16000000-0000-0000-0000-000000000007'), 'Omeprazole 20 mg', 'Omeprazole', '20 mg', 'vien', '1 vien', 1, 'ORAL', 7, 7, 'Uong truoc an sang 30 phut.', '2026-08-20 02:30:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000003'), UUID_TO_BIN('16200000-0000-0000-0000-000000000002'), UUID_TO_BIN('16000000-0000-0000-0000-000000000003'), 'Amoxicillin 500 mg', 'Amoxicillin', '500 mg', 'vien', '1 vien', 3, 'ORAL', 5, 15, 'Dung du lieu trinh dieu tri.', '2026-08-20 02:35:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000004'), UUID_TO_BIN('16200000-0000-0000-0000-000000000002'), UUID_TO_BIN('16000000-0000-0000-0000-000000000012'), 'Ambroxol 30 mg', 'Ambroxol', '30 mg', 'vien', '1 vien', 3, 'ORAL', 5, 15, 'Uong nhieu nuoc.', '2026-08-20 02:35:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000005'), UUID_TO_BIN('16200000-0000-0000-0000-000000000003'), UUID_TO_BIN('16000000-0000-0000-0000-000000000016'), 'Metformin 500 mg', 'Metformin', '500 mg', 'vien', '1 vien', 2, 'ORAL', 30, 60, 'Uong trong hoac sau an.', '2026-08-20 02:40:00', '2026-08-20 02:45:00'),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000006'), UUID_TO_BIN('16200000-0000-0000-0000-000000000003'), UUID_TO_BIN('16000000-0000-0000-0000-000000000017'), 'Gliclazide MR 30 mg', 'Gliclazide', '30 mg', 'vien', '1 vien', 1, 'ORAL', 30, 30, 'Uong cung bua an sang.', '2026-08-20 02:45:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000007'), UUID_TO_BIN('16200000-0000-0000-0000-000000000004'), UUID_TO_BIN('16000000-0000-0000-0000-000000000002'), 'Ibuprofen 400 mg', 'Ibuprofen', '400 mg', 'vien', '1 vien', 2, 'ORAL', 3, 6, 'Don nay da huy, khong cap phat.', '2026-08-20 02:42:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000008'), UUID_TO_BIN('16200000-0000-0000-0000-000000000005'), UUID_TO_BIN('16000000-0000-0000-0000-000000000002'), 'Ibuprofen 400 mg', 'Ibuprofen', '400 mg', 'vien', '1 vien', 2, 'ORAL', 3, 6, 'Can nhac nguy co xuat huyet va theo doi sat.', '2026-08-20 02:47:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000009'), UUID_TO_BIN('16200000-0000-0000-0000-000000000005'), UUID_TO_BIN('16000000-0000-0000-0000-000000000029'), 'Warfarin 2 mg', 'Warfarin', '2 mg', 'vien', '1 vien', 1, 'ORAL', 7, 7, 'Dung theo chi dinh chong dong hien tai.', '2026-08-20 02:47:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000010'), UUID_TO_BIN('16200000-0000-0000-0000-000000000006'), UUID_TO_BIN('16000000-0000-0000-0000-000000000019'), 'Amlodipine 5 mg', 'Amlodipine', '5 mg', 'vien', '1 vien', 1, 'ORAL', 30, 30, 'Theo doi huyet ap tai nha.', '2026-08-20 02:50:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000011'), UUID_TO_BIN('16200000-0000-0000-0000-000000000006'), UUID_TO_BIN('16000000-0000-0000-0000-000000000020'), 'Losartan 50 mg', 'Losartan', '50 mg', 'vien', '1 vien', 1, 'ORAL', 30, 30, 'Theo doi huyet ap va chuc nang than.', '2026-08-20 02:50:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000012'), UUID_TO_BIN('16200000-0000-0000-0000-000000000006'), UUID_TO_BIN('16000000-0000-0000-0000-000000000018'), 'Atorvastatin 20 mg', 'Atorvastatin', '20 mg', 'vien', '1 vien', 1, 'ORAL', 30, 30, 'Uong buoi toi.', '2026-08-20 02:50:00', NULL);
