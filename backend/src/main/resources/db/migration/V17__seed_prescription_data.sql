...
(UUID_TO_BIN('16000000-0000-0000-0000-000000000001'), 'MED-PARA-500', 'Paracetamol 500 mg', 'Paracetamol', '500 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 120, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000002'), 'MED-IBU-400', 'Ibuprofen 400 mg', 'Ibuprofen', '400 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 80, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000003'), 'MED-AMOX-500', 'Amoxicillin 500 mg', 'Amoxicillin', '500 mg', 'CAPSULE', 'viên', 'ORAL', TRUE, 0, 100, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000004'), 'MED-AMCL-625', 'Amoxicillin Clavulanate 625 mg', 'Amoxicillin + Clavulanic acid', '625 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 60, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000005'), 'MED-AZI-500', 'Azithromycin 500 mg', 'Azithromycin', '500 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 50, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000006'), 'MED-CEFU-500', 'Cefuroxime 500 mg', 'Cefuroxime', '500 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 50, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000007'), 'MED-OMEP-20', 'Omeprazole 20 mg', 'Omeprazole', '20 mg', 'CAPSULE', 'viên', 'ORAL', TRUE, 0, 70, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000008'), 'MED-ESOM-40', 'Esomeprazole 40 mg', 'Esomeprazole', '40 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 40, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000009'), 'MED-CETI-10', 'Cetirizine 10 mg', 'Cetirizine', '10 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 60, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000010'), 'MED-LORA-10', 'Loratadine 10 mg', 'Loratadine', '10 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 60, '2026-08-01 01:00:00', NULL),
...
(UUID_TO_BIN('16000000-0000-0000-0000-000000000012'), 'MED-AMBRO-30', 'Ambroxol 30 mg', 'Ambroxol', '30 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 50, '2026-08-01 01:00:00', NULL),
...
(UUID_TO_BIN('16000000-0000-0000-0000-000000000014'), 'MED-SALBU-2', 'Salbutamol 2 mg', 'Salbutamol', '2 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 40, '2026-08-01 01:00:00', NULL),
...
(UUID_TO_BIN('16000000-0000-0000-0000-000000000016'), 'MED-METFO-500', 'Metformin 500 mg', 'Metformin', '500 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 120, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000017'), 'MED-GLIC-30', 'Gliclazide MR 30 mg', 'Gliclazide', '30 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 80, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000018'), 'MED-ATOR-20', 'Atorvastatin 20 mg', 'Atorvastatin', '20 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 60, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000019'), 'MED-AMLO-5', 'Amlodipine 5 mg', 'Amlodipine', '5 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 80, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000020'), 'MED-LOSAR-50', 'Losartan 50 mg', 'Losartan', '50 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 80, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000021'), 'MED-DICLO-50', 'Diclofenac 50 mg', 'Diclofenac', '50 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 40, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000022'), 'MED-MELOX-7', 'Meloxicam 7.5 mg', 'Meloxicam', '7.5 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 30, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000023'), 'MED-PRED-5', 'Prednisolone 5 mg', 'Prednisolone', '5 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 40, '2026-08-01 01:00:00', NULL),
...
(UUID_TO_BIN('16000000-0000-0000-0000-000000000026'), 'MED-LOPE-2', 'Loperamide 2 mg', 'Loperamide', '2 mg', 'CAPSULE', 'viên', 'ORAL', TRUE, 0, 30, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000027'), 'MED-BISAC-5', 'Bisacodyl 5 mg', 'Bisacodyl', '5 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 30, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000028'), 'MED-LEVO-500', 'Levofloxacin 500 mg', 'Levofloxacin', '500 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 35, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000029'), 'MED-WARF-2', 'Warfarin 2 mg', 'Warfarin', '2 mg', 'TABLET', 'viên', 'ORAL', TRUE, 0, 25, '2026-08-01 01:00:00', NULL),
(UUID_TO_BIN('16000000-0000-0000-0000-000000000030'), 'MED-ASP-81', 'Aspirin 81 mg', 'Acetylsalicylic acid', '81 mg', 'TABLET', 'viên', 'ORAL', FALSE, 0, 40, '2026-08-01 01:00:00', '2026-08-15 01:00:00');
...
(UUID_TO_BIN('16300000-0000-0000-0000-000000000001'), UUID_TO_BIN('16200000-0000-0000-0000-000000000001'), UUID_TO_BIN('16000000-0000-0000-0000-000000000001'), 'Paracetamol 500 mg', 'Paracetamol', '500 mg', 'viên', '1 viên', 'Moi 8 gio khi dau', 'ORAL', 3, 9, 'Uong sau an, toi da 3 g moi ngay.', '2026-08-20 02:30:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000002'), UUID_TO_BIN('16200000-0000-0000-0000-000000000001'), UUID_TO_BIN('16000000-0000-0000-0000-000000000007'), 'Omeprazole 20 mg', 'Omeprazole', '20 mg', 'viên', '1 viên', 'Moi sang', 'ORAL', 7, 7, 'Uong truoc an sang 30 phut.', '2026-08-20 02:30:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000003'), UUID_TO_BIN('16200000-0000-0000-0000-000000000002'), UUID_TO_BIN('16000000-0000-0000-0000-000000000003'), 'Amoxicillin 500 mg', 'Amoxicillin', '500 mg', 'viên', '1 viên', 'Moi 8 gio', 'ORAL', 5, 15, 'Dung du lieu trinh dieu tri.', '2026-08-20 02:35:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000004'), UUID_TO_BIN('16200000-0000-0000-0000-000000000002'), UUID_TO_BIN('16000000-0000-0000-0000-000000000012'), 'Ambroxol 30 mg', 'Ambroxol', '30 mg', 'viên', '1 viên', 'Ngay 3 lan', 'ORAL', 5, 15, 'Uong nhieu nuoc.', '2026-08-20 02:35:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000005'), UUID_TO_BIN('16200000-0000-0000-0000-000000000003'), UUID_TO_BIN('16000000-0000-0000-0000-000000000016'), 'Metformin 500 mg', 'Metformin', '500 mg', 'viên', '1 viên', 'Ngay 2 lan', 'ORAL', 30, 60, 'Uong trong hoac sau an.', '2026-08-20 02:40:00', '2026-08-20 02:45:00'),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000006'), UUID_TO_BIN('16200000-0000-0000-0000-000000000003'), UUID_TO_BIN('16000000-0000-0000-0000-000000000017'), 'Gliclazide MR 30 mg', 'Gliclazide', '30 mg', 'viên', '1 viên', 'Moi sang', 'ORAL', 30, 30, 'Uong cung bua an sang.', '2026-08-20 02:45:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000007'), UUID_TO_BIN('16200000-0000-0000-0000-000000000004'), UUID_TO_BIN('16000000-0000-0000-0000-000000000002'), 'Ibuprofen 400 mg', 'Ibuprofen', '400 mg', 'viên', '1 viên', 'Ngay 2 lan', 'ORAL', 3, 6, 'Don nay da huy, khong cap phat.', '2026-08-20 02:42:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000008'), UUID_TO_BIN('16200000-0000-0000-0000-000000000005'), UUID_TO_BIN('16000000-0000-0000-0000-000000000002'), 'Ibuprofen 400 mg', 'Ibuprofen', '400 mg', 'viên', '1 viên', 'Ngay 2 lan', 'ORAL', 3, 6, 'Can nhac nguy co xuat huyet va theo doi sat.', '2026-08-20 02:47:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000009'), UUID_TO_BIN('16200000-0000-0000-0000-000000000005'), UUID_TO_BIN('16000000-0000-0000-0000-000000000029'), 'Warfarin 2 mg', 'Warfarin', '2 mg', 'viên', '1 viên', 'Moi toi', 'ORAL', 7, 7, 'Dung theo chi dinh chong dong hien tai.', '2026-08-20 02:47:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000010'), UUID_TO_BIN('16200000-0000-0000-0000-000000000006'), UUID_TO_BIN('16000000-0000-0000-0000-000000000019'), 'Amlodipine 5 mg', 'Amlodipine', '5 mg', 'viên', '1 viên', 'Moi sang', 'ORAL', 30, 30, 'Theo doi huyet ap tai nha.', '2026-08-20 02:50:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000011'), UUID_TO_BIN('16200000-0000-0000-0000-000000000006'), UUID_TO_BIN('16000000-0000-0000-0000-000000000020'), 'Losartan 50 mg', 'Losartan', '50 mg', 'viên', '1 viên', 'Moi sang', 'ORAL', 30, 30, 'Theo doi huyet ap va chuc nang than.', '2026-08-20 02:50:00', NULL),
(UUID_TO_BIN('16300000-0000-0000-0000-000000000012'), UUID_TO_BIN('16200000-0000-0000-0000-000000000006'), UUID_TO_BIN('16000000-0000-0000-0000-000000000018'), 'Atorvastatin 20 mg', 'Atorvastatin', '20 mg', 'viên', '1 viên', 'Moi toi', 'ORAL', 30, 30, 'Uong buoi toi.', '2026-08-20 02:50:00', NULL);
...
(
    ...
    JSON_OBJECT('schemaVersion', 1, 'prescriptionCode', 'RX000003', 'status', 'PENDING_DISPENSE', 'note', 'Don mau cho cap phat va dieu chinh.', 'items', JSON_ARRAY(JSON_OBJECT('medicineName', 'Metformin 500 mg', 'dosage', '1 viên', 'quantity', 60))),
    JSON_OBJECT('schemaVersion', 1, 'prescriptionCode', 'RX000003', 'status', 'PENDING_DISPENSE', 'note', 'Don mau cho cap phat va dieu chinh.', 'items', JSON_ARRAY(JSON_OBJECT('medicineName', 'Metformin 500 mg', 'dosage', '1 viên', 'quantity', 60), JSON_OBJECT('medicineName', 'Gliclazide MR 30 mg', 'dosage', '1 viên', 'quantity', 30))),
