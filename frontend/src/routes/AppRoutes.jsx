  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="doctor-schedules" element={<PrivateRoute allowedPermissions={['DOCTOR_SCHEDULE_UPDATE', 'DOCTOR_TIMEOFF_CREATE', 'DOCTOR_TIMEOFF_CANCEL']} allowedRoles={['admin', 'manager', 'clinic_manager', 'doctor']}><LazyPage><DoctorScheduleManagementPage /></LazyPage></PrivateRoute>} />
