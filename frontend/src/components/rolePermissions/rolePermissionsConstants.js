...
export const MODULE_ICONS = {
  USER: React.createElement(UserOutlined, { style: { color: '#2563eb' } }),
  ROLE: React.createElement(SafetyCertificateOutlined, { style: { color: '#7c3aed' } }),
  PERMISSION: React.createElement(KeyOutlined, { style: { color: '#d97706' } }),
  PATIENT: React.createElement(TeamOutlined, { style: { color: '#059669' } }),
  MEDICAL_RECORD: React.createElement(FileTextOutlined, { style: { color: '#0284c7' } }),
  APPOINTMENT: React.createElement(CalendarOutlined, { style: { color: '#ea580c' } }),
  PRESCRIPTION: React.createElement(MedicineBoxOutlined, { style: { color: '#dc2626' } }),
  PHARMACY: React.createElement(ShopOutlined, { style: { color: '#16a34a' } }),
  VITAL_SIGN: React.createElement(HeartOutlined, { style: { color: '#e11d48' } }),
  DIAGNOSIS: React.createElement(ExperimentOutlined, { style: { color: '#9333ea' } }),
  INVOICE: React.createElement(DollarOutlined, { style: { color: '#ca8a04' } }),
  QUEUE: React.createElement(UnorderedListOutlined, { style: { color: '#0d9488' } }),
  SERVICE_CATALOG: React.createElement(AppstoreOutlined, { style: { color: '#4f46e5' } }),
  ROOM: React.createElement(BankOutlined, { style: { color: '#475569' } }),
  CLINICAL_ORDER: React.createElement(FormOutlined, { style: { color: '#2563eb' } }),
  CLINICAL_RESULT: React.createElement(FundViewOutlined, { style: { color: '#0891b2' } }),
  CLINICAL_SERVICE: React.createElement(BranchesOutlined, { style: { color: '#059669' } }),
  FOLLOW_UP: React.createElement(ClockCircleOutlined, { style: { color: '#d97706' } }),
  CARE_LOG: React.createElement(AuditOutlined, { style: { color: '#0284c7' } }),
  CLINIC_CONFIGURATION: React.createElement(SettingOutlined, { style: { color: '#64748b' } }),
  BACKUP: React.createElement(DatabaseOutlined, { style: { color: '#7c3aed' } }),
  REPORT: React.createElement(BarChartOutlined, { style: { color: '#2563eb' } }),
  DASHBOARD: React.createElement(DashboardOutlined, { style: { color: '#059669' } }),
  AUDIT: React.createElement(SecurityScanOutlined, { style: { color: '#dc2626' } }),
}
