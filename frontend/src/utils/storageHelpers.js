...
export const DEFAULT_MEDICINES = [
  { id: '16000000-0000-0000-0000-000000000001', code: 'MED-PARA-500', name: 'Paracetamol 500 mg', activeIngredient: 'Paracetamol', strength: '500 mg', category: 'Hạ sốt, giảm đau', unit: 'viên', defaultRoute: 'ORAL', stock: 1500, minStock: 200, active: true, price: 1500 },
  { id: '16000000-0000-0000-0000-000000000002', code: 'MED-IBU-400', name: 'Ibuprofen 400 mg', activeIngredient: 'Ibuprofen', strength: '400 mg', category: 'Giảm đau, kháng viêm', unit: 'viên', defaultRoute: 'ORAL', stock: 800, minStock: 150, active: true, price: 2500 },
  { id: '16000000-0000-0000-0000-000000000003', code: 'MED-AMOX-500', name: 'Amoxicillin 500 mg', activeIngredient: 'Amoxicillin', strength: '500 mg', category: 'Kháng sinh', unit: 'viên', defaultRoute: 'ORAL', stock: 1200, minStock: 150, active: true, price: 3500 },
  { id: '16000000-0000-0000-0000-000000000004', code: 'MED-AMCL-625', name: 'Amoxicillin Clavulanate 625 mg', activeIngredient: 'Amoxicillin + Clavulanic acid', strength: '625 mg', category: 'Kháng sinh', unit: 'viên', defaultRoute: 'ORAL', stock: 600, minStock: 100, active: true, price: 6500 },
  { id: '16000000-0000-0000-0000-000000000005', code: 'MED-AZI-500', name: 'Azithromycin 500 mg', activeIngredient: 'Azithromycin', strength: '500 mg', category: 'Kháng sinh', unit: 'viên', defaultRoute: 'ORAL', stock: 400, minStock: 100, active: true, price: 8500 },
  { id: '16000000-0000-0000-0000-000000000006', code: 'MED-CEFU-500', name: 'Cefuroxime 500 mg', activeIngredient: 'Cefuroxime', strength: '500 mg', category: 'Kháng sinh', unit: 'viên', defaultRoute: 'ORAL', stock: 450, minStock: 100, active: true, price: 8500 },
  { id: '16000000-0000-0000-0000-000000000007', code: 'MED-OMEP-20', name: 'Omeprazole 20 mg', activeIngredient: 'Omeprazole', strength: '20 mg', category: 'Dạ dày - Tiêu hóa', unit: 'viên', defaultRoute: 'ORAL', stock: 900, minStock: 100, active: true, price: 2500 },
  { id: '16000000-0000-0000-0000-000000000008', code: 'MED-ESOM-40', name: 'Esomeprazole 40 mg', activeIngredient: 'Esomeprazole', strength: '40 mg', category: 'Dạ dày - Tiêu hóa', unit: 'viên', defaultRoute: 'ORAL', stock: 750, minStock: 100, active: true, price: 4500 },
  { id: '16000000-0000-0000-0000-000000000009', code: 'MED-CETI-10', name: 'Cetirizine 10 mg', activeIngredient: 'Cetirizine', strength: '10 mg', category: 'Dị ứng, Kháng Histamine', unit: 'viên', defaultRoute: 'ORAL', stock: 1000, minStock: 150, active: true, price: 1500 },
  { id: '16000000-0000-0000-0000-000000000010', code: 'MED-LORA-10', name: 'Loratadine 10 mg', activeIngredient: 'Loratadine', strength: '10 mg', category: 'Dị ứng, Kháng Histamine', unit: 'viên', defaultRoute: 'ORAL', stock: 850, minStock: 150, active: true, price: 1500 },
  ...
  { id: '16000000-0000-0000-0000-000000000012', code: 'MED-AMBRO-30', name: 'Ambroxol 30 mg', activeIngredient: 'Ambroxol', strength: '30 mg', category: 'Hô hấp, Long đờm', unit: 'viên', defaultRoute: 'ORAL', stock: 1100, minStock: 200, active: true, price: 1800 },
  ...
  { id: '16000000-0000-0000-0000-000000000014', code: 'MED-SALBU-2', name: 'Salbutamol 2 mg', activeIngredient: 'Salbutamol', strength: '2 mg', category: 'Hô hấp, Dãn phế quản', unit: 'viên', defaultRoute: 'ORAL', stock: 500, minStock: 100, active: true, price: 1200 },
  ...
  { id: '16000000-0000-0000-0000-000000000016', code: 'MED-METFO-500', name: 'Metformin 500 mg', activeIngredient: 'Metformin', strength: '500 mg', category: 'Nội tiết - Đái tháo đường', unit: 'viên', defaultRoute: 'ORAL', stock: 1200, minStock: 200, active: true, price: 2500 },
  { id: '16000000-0000-0000-0000-000000000017', code: 'MED-GLIC-30', name: 'Gliclazide MR 30 mg', activeIngredient: 'Gliclazide', strength: '30 mg', category: 'Nội tiết - Đái tháo đường', unit: 'viên', defaultRoute: 'ORAL', stock: 950, minStock: 150, active: true, price: 3200 },
  { id: '16000000-0000-0000-0000-000000000018', code: 'MED-ATOR-20', name: 'Atorvastatin 20 mg', activeIngredient: 'Atorvastatin', strength: '20 mg', category: 'Tim mạch, Hạ mỡ máu', unit: 'viên', defaultRoute: 'ORAL', stock: 800, minStock: 150, active: true, price: 4500 },
  { id: '16000000-0000-0000-0000-000000000019', code: 'MED-AMLO-5', name: 'Amlodipine 5 mg', activeIngredient: 'Amlodipine', strength: '5 mg', category: 'Tim mạch - Huyết áp', unit: 'viên', defaultRoute: 'ORAL', stock: 900, minStock: 200, active: true, price: 2000 },
  { id: '16000000-0000-0000-0000-000000000020', code: 'MED-LOSAR-50', name: 'Losartan 50 mg', activeIngredient: 'Losartan', strength: '50 mg', category: 'Tim mạch - Huyết áp', unit: 'viên', defaultRoute: 'ORAL', stock: 700, minStock: 100, active: true, price: 3000 },
  { id: '16000000-0000-0000-0000-000000000021', code: 'MED-DICLO-50', name: 'Diclofenac 50 mg', activeIngredient: 'Diclofenac', strength: '50 mg', category: 'Giảm đau, Kháng viêm', unit: 'viên', defaultRoute: 'ORAL', stock: 600, minStock: 100, active: true, price: 2000 },
  { id: '16000000-0000-0000-0000-000000000022', code: 'MED-MELOX-7', name: 'Meloxicam 7.5 mg', activeIngredient: 'Meloxicam', strength: '7.5 mg', category: 'Giảm đau, Kháng viêm', unit: 'viên', defaultRoute: 'ORAL', stock: 550, minStock: 100, active: true, price: 2800 },
  { id: '16000000-0000-0000-0000-000000000023', code: 'MED-PRED-5', name: 'Prednisolone 5 mg', activeIngredient: 'Prednisolone', strength: '5 mg', category: 'Corticoid, Kháng viêm', unit: 'viên', defaultRoute: 'ORAL', stock: 1500, minStock: 200, active: true, price: 1500 },
  ...
  { id: '16000000-0000-0000-0000-000000000026', code: 'MED-LOPE-2', name: 'Loperamide 2 mg', activeIngredient: 'Loperamide', strength: '2 mg', category: 'Tiêu hóa, Cầm tiêu chảy', unit: 'viên', defaultRoute: 'ORAL', stock: 400, minStock: 50, active: true, price: 1500 },
  { id: '16000000-0000-0000-0000-000000000027', code: 'MED-BISAC-5', name: 'Bisacodyl 5 mg', activeIngredient: 'Bisacodyl', strength: '5 mg', category: 'Tiêu hóa, Nhuận tràng', unit: 'viên', defaultRoute: 'ORAL', stock: 350, minStock: 50, active: true, price: 2000 },
  { id: '16000000-0000-0000-0000-000000000028', code: 'MED-LEVO-500', name: 'Levofloxacin 500 mg', activeIngredient: 'Levofloxacin', strength: '500 mg', category: 'Kháng sinh Quinoline', unit: 'viên', defaultRoute: 'ORAL', stock: 300, minStock: 50, active: true, price: 12000 },
  { id: '16000000-0000-0000-0000-000000000029', code: 'MED-WARF-2', name: 'Warfarin 2 mg', activeIngredient: 'Warfarin', strength: '2 mg', category: 'Tim mạch, Chống đông', unit: 'viên', defaultRoute: 'ORAL', stock: 450, minStock: 50, active: true, price: 3500 },
  { id: '16000000-0000-0000-0000-000000000030', code: 'MED-ASP-81', name: 'Aspirin 81 mg', activeIngredient: 'Acetylsalicylic acid', strength: '81 mg', category: 'Tim mạch, Thải trừ huyết khối', unit: 'viên', defaultRoute: 'ORAL', stock: 1000, minStock: 100, active: true, price: 1500 },
]
